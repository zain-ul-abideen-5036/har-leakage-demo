...
*Figure: Naive random split vs. subject level split, side by side*
...
*Figure: Accuracy comparison, naive split vs. subject level split, both models*
...
*Figure: PCA embedding, colored by subject identity vs. colored by activity class*
...
*Figure: Confusion matrices, naive split vs. subject level split*
...
The full code behind every number and figure in this article, the dataset generator, both experiments, and the figure generation scripts, is available as a small open repository. Clone it, run it, and change the random seed if you want to convince yourself this isn't a cherry picked result.
